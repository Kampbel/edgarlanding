...
const academicProjects = [
  {
    ...
    category: 'publicidad',
    type: 'académico',
    description: 'Diseño de cartel conmemorativo desarrollado para la iniciativa Creare en Galería 360, enfocado en rendir homenaje a la trayectoria y legado musical del artista Juan Luis Guerra a través de una cuidada composición tipográfica.',
  ...
  },
  {
    ...
    category: 'publicidad',
    type: 'académico',
    description: 'Cartel gráfico que celebra la diversidad y la identidad latinoamericana, integrando elementos simbólicos y las banderas representativas de las naciones de la comunidad latina.',
  ...
  },
  {
    ...
    category: 'publicidad',
    type: 'académico',
    description: 'Pieza gráfica publicitaria que explora la semiótica y los mensajes conceptuales implícitos, utilizando la relación figura-fondo para transmitir ideas de alto valor sintáctico.',
  ...
  },
  {
    ...
    category: 'publicidad',
    type: 'académico',
    description: 'Serie de carteles publicitarios diseñados para resaltar la identidad caribeña y la dominicanidad de la marca Cerveza República, priorizando el atractivo visual y el posicionamiento de producto.',
  ...
  },
  {
    ...
    category: 'branding',
    type: 'académico',
    description: 'Desarrollo conceptual de identidad de marca para un hotel & resort ficticio inspirado en la Cayena, flor nacional dominicana. Incluye diseño de logotipo, manual de aplicación gráfica, papelería y empaques.',
    images: [
  ...
  },
  {
    ...
    category: 'branding',
    type: 'académico',
    description: 'Proyecto integral de branding y manual de identidad para una agencia de diseño ficticia, abarcando conceptualización de marca, diseño de logotipo, tipografía corporativa y aplicaciones multiplataforma.',
    images: [
  ...
  },
  {
    ...
    category: 'editorial',
    type: 'académico',
    description: 'Diseño editorial de un folleto informativo y educativo diseñado para concientizar sobre el cuidado del medio ambiente y el valor de la sostenibilidad.',
  ...
  {
    id: 'lolita-terror',
    title: 'Lolita & The House of Terror',
    subtitle: 'Diseño de Portadas',
    category: 'editorial',
    type: 'académico',
    description: 'Diseño editorial y maqueta de portadas para obras literarias de ficción dramática y terror, explorando tratamientos tipográficos expresivos e imaginería conceptual.',
  ...
  },
  {
    ...
    category: 'editorial',
    type: 'académico',
    description: 'Propuesta de ilustración y diagramación para un cuento infantil, combinando paletas de color envolventes y personajes narrativos.',
  ...
  },
  {
    ...
    category: 'editorial',
    type: 'académico',
    description: 'Diseño de portada y contraportada para revista de tendencia urbana, enfocado en la jerarquía visual, diagramación editorial y tratamiento tipográfico contemporáneo.',
